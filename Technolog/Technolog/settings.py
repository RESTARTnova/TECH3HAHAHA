"""
Django settings for Technolog project.
...
SECRET_KEY = 'django-insecure-phf#p(&@2_h05uvf1eg4&$fea^t26g3_3itxqes9s4rx^awts&'
...
WSGI_APPLICATION = 'Technolog.wsgi.application'
